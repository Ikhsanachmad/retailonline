...
use App\Http\Livewire\ReturnComponent;
...
Route::get('/terms-condition',TermsComponent::class)->name('terms');

Route::get('/return-policy',ReturnComponent::class)->name('return');
