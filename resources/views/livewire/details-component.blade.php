                    ...
                    <div class="detail-info">
                        <div class="product-rating">
                            ...
                            @for($i=1;$i<=5;$i++)
                                ...
                                @endif                                
                            @endfor                           
                            <a href="#" class="count-review">({{ $product->orderItems->where('rstatus',1)->count()}} ulasan)</a>
                        </div>
                        ...
                        <div class="wrap-butons">
                            @if ($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now() )
                                <a href="#" class="btn add-to-cart" wire:click.prevent="store({{ $product->id }}, '{{ $product->name }}', {{ $product->sale_price }})">+Keranjang</a>
                            @else                            
                        ...
                        <div class="tab-contents">
                            ...
                            <div class="tab-content-item " id="review">
                                ...
                                <div class="wrap-review-form">
                                    ...
                                    <div id="comments">
                                        <h2 class="woocommerce-Reviews-title">{{ $product->orderItems->where('rstatus',1)->count() }} Ulasan <span>{{ $product->name }}</span></h2>
                                                ...
                                                <div id="comment-20" class="comment_container"> 
                                                    ...
                                                    <div class="comment-text">
                                                        <div class="star-rating">
                                                            <span class="width-{{ $orderItem->review->rating * 20 }}-percent">Penilaian <strong class="rating">{{ $orderItem->review->rating }}</strong> out of 5</span>
                                                        </div>
                                                        <p class="meta"> 
