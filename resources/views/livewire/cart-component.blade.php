        ...
        <div class=" main-content-area">
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="quantity">
                                ...
                                <p class="text-center" wire:click.prevent="switchToSaveForLater('{{ $item->rowId }}')"><a href="#">Simpan Nanti</a></p>
                            </div>
            ...
            <div class="summary">
                <div class="order-summary">
                    <h4 class="title-box">Ringkasan Belanja</h4>
                    <p class="summary-info"><span class="title">Subtotal</span><b class="index">Rp{{Cart::instance('cart')->subtotal()}}</b></p>
                    @if (Session::has('coupon'))                                            
                        <p class="summary-info"><span class="title">Potongan ({{ Session::get('coupon')['code'] }}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-times text-danger"></i></a></span><b class="index"> -Rp{{ number_format($discount,3) }}</b></p>
                        <p class="summary-info"><span class="title">Subtotal Potongan</span><b class="index">Rp{{ number_format($subtotalAfterDiscount,3) }}</b></p>
                        <p class="summary-info"><span class="title">Pajak ({{ config('cart.tax')}}%)</span><b class="index">Rp{{ number_format($taxAfterDiscount,3) }}</b></p>                        
                    ...
                    @else
                        ...
                        {{-- <p class="summary-info"><span class="title">Kode Unik</span><b class="index">+ Rp{{ number_format($totalAfterDiscount) }}</b></p> --}}
                    ...
                    <div class="checkout-info">
                        ...
                        <label class="checkbox-field">
                            <input class="frm-input " name="have-code" id="have-code" value="1" type="checkbox" wire:model="haveCouponCode"><span>Saya Punya Kupon</span>
                        </label>
                        @if ($haveCouponCode == 1)                                       
                            <div class="summary-item">
                                <form wire:submit.prevent="applyCouponCode">
                                    <h4 class="title-box">Kode Kupon</h4>
                                    @if (Session::has('coupon_message'))
                                        <div class="alert alert-danger" role="danger">{{Session::get('coupon_message')}}</div>
                                    @endif
                                    <p class="row-in-form">
                                        <label for="coupon-code">Masukkan Kupon:</label>    
                ...
                @endif
                        ...
                        <a class="link-to-shop" href="shop.html">Lanjut Belanja<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
                    </div>
                <div class="update-clear">
                    <a class="btn btn-clear" href="#" wire:click.prevent="destroyAll()">Hapus Semua Keranjang</a>
            ...
            <div class="wrap-iten-in-cart">
                <h3 class="title-box" style="border-bottom: 1px solid; padding-bottom:15px;">{{Cart::instance('saveForLater')->count()}} item(s) Saved Later</h3>
                ...
                @if(Cart::instance('saveForLater')->count() > 0)            
                    ...
                    <ul class="products-cart">
                        ...
                        <li class="pr-cart-item">
                            ...
                            <div class="price-field produtc-price"><p class="price">Rp{{ $item->model->regular_price }}</p></div>
                            <div class="quantity">                                
                                <p class="text-center" wire:click.prevent="moveToCart('{{ $item->rowId }}')"><a href="#">+Keranjang</a></p>
                            </div>                            
                            <div class="delete">
                                <a href="#" wire:click.prevent="deletFromSaveForLater('{{ $item->rowId }}')" class="btn btn-delete" title="">
                                    <span>Hapus simpan nanti</span>
                                    <i class="fa fa-times-circle" aria-hidden="true"></i>
                                </a>
                            </div>
                        </li> 
            ...
            <div class="wrap-show-advance-info-box style-1">
				<h3 class="title-box">Produk Terakhir Dilihat</h3>
