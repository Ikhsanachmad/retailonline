    ...
    <div class="container">
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Produk Kategori</span></li>
        ...
        <div class="row">
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting" >
                                <option value="default" selected="selected">Urutan bawaan</option>
                                <option value="date">Urutan terbaru</option>
                                <option value="price">Urutan harga: rendah - tinggi</option>
                                <option value="price-desc">Urutan harga: tinggi - rendah </option>
                            </select>
                        </div>

                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="pagesize">
                                <option value="5" selected="selected">5 per halaman</option>
                                <option value="6">6 per halaman</option>
                                <option value="7">7 per halaman</option>
                        ...
                        <li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <a href="#" class="btn add-to-cart" wire:click.prevent="store({{ $product->id}},'{{ $product->name }}',{{ $product->regular_price }})">+Keranjang</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget filter-widget price-filter">
                    <h2 class="widget-title">Harga <span class="text-info">Rp{{ number_format($min_price,3) }} - Rp{{ number_format($max_price,3) }}</h2>
