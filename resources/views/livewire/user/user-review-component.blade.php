        ...
        <div class="row">
            <div class="col-md-12">
                <div id="review_form_wrapper">
                    <div id="comments">
                        <h2 class="woocommerce-Reviews-title">Beri Penilaian </h2>
                            ...
                            <form wire:submit.prevent="addReview" id="commentform" class="comment-form">                                
                                <div class="comment-form-rating">
                                    ...
                                    <p class="stars">
                                        ...
                                        @error('rating') <span class="text-danger">{{ $massage }}</span> @enderror
                                    </p>
                                </div>                                
                                <p class="comment-form-comment">
                                    <label for="comment">Ulasan <span class="required">*</span>
                                    </label>
                                    <textarea id="comment" name="comment" cols="45" rows="8" wire:model="comment"></textarea>
                                    @error('comment') <span class="text-danger">{{ $massage }}</span> @enderror
                                </p>
                                <p class="form-submit">
