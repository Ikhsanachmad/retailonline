		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Lupa Kata Sandi</span></li>
				</ul>
			</div>
			<div class="row">
							...
							<div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('password.email') }}">
                                    ...
                                    <fieldset class="wrap-title">
										<h3 class="form-title">Lupa Kata Sandi Akun</h3>										
									</fieldset>
									...
									<input type="submit" class="btn btn-submit" value="Kata Sandi Reset" name="submit">
								</form>
							</div>												
						</div>
