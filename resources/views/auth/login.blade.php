						...
						<div class="wrap-login-item ">						
							<div class="login-form form-item form-stl">
                                ...
                                <form name="frm-login" method="POST" action="{{ route('login') }}">
									...
									<fieldset class="wrap-input">										
										<a class="link-function" href="{{ route('register') }}" title="register" >Register</a>									
										<a class="link-function left-position" href="{{ route('password.request') }}" title="Lupa Kata Sandi?">Lupa Kata Sandi ?</a>
									</fieldset>
